...
const users = [
  ...
  {
    name: "Efrain Chavez",
    username: "efrain.chavez",
    email: "efrain@northwind.io",
    password: DEMO_PASSWORD,
    companyDomain: "northwind.io",
    role: "responder",
    isAdmin: false,
  ...
  {
    name: "Melissa Bowerson",
    username: "melissa.bowerson",
    email: "melissa@northwind.io",
    password: DEMO_PASSWORD,
    companyDomain: "northwind.io",
    role: "responder",
    isAdmin: false,
  ...
  {
    name: "Isabelle Voltz",
    username: "isabelle.voltz",
    email: "isabelle@northwind.io",
    password: DEMO_PASSWORD,
    companyDomain: "northwind.io",
    role: "observer",
    isAdmin: false,
  ...
  {
    name: "Daniel Cigan",
    username: "daniel.cigan",
    email: "daniel@apexcommerce.com",
    password: DEMO_PASSWORD,
    companyDomain: "apexcommerce.com",
    role: "responder",
    isAdmin: false,
  ...
  {
    name: "Renee Blackburn",
    username: "renee.blackburn",
    email: "renee@apexcommerce.com",
    password: DEMO_PASSWORD,
    companyDomain: "apexcommerce.com",
    role: "observer",
    isAdmin: false,
  ...
  {
    name: "Trent Saulsgiver",
    username: "trent.saulsgiver",
    email: "trent@apexcommerce.com",
    password: DEMO_PASSWORD,
    companyDomain: "apexcommerce.com",
    role: "observer",
    isAdmin: false,
  ...
  {
    name: "Luis Garces",
    username: "luis.garces",
    email: "luis@vertexhealth.org",
    password: DEMO_PASSWORD,
    companyDomain: "vertexhealth.org",
    role: "responder",
    isAdmin: false,
  ...
  {
    name: "Ezekiel Jennings",
    username: "ezekiel.jennings",
    email: "ezekiel@vertexhealth.org",
    password: DEMO_PASSWORD,
    companyDomain: "vertexhealth.org",
    role: "responder",
    isAdmin: false,
  ...
  {
    name: "Nikki Edwards",
    username: "nikki.edwards",
    email: "nikki@vertexhealth.org",
    password: DEMO_PASSWORD,
    companyDomain: "vertexhealth.org",
    role: "observer",
    isAdmin: false,
  ...
  {
    name: "Emma Searing",
    username: "emma.searing",
    email: "emma@vertexhealth.org",
    password: DEMO_PASSWORD,
    companyDomain: "vertexhealth.org",
    role: "observer",
    isAdmin: false,
